...
<tr>
    ...
    <td>£<?php if($product['discount_price']){echo $product['discount_price'];} else {echo $product['price'];} ?></td>
    <td>
        <div class="qty">
            <form method="POST">
    ...
    <td>£<?php if($product['discount_price']){$itemtotal = $product['quantity'] * $product['discount_price'];} else {$itemtotal = $product['quantity'] * $product['price'];} echo $itemtotal; ?></td>
